...
//                $file = YITH_WPV_PATH . 'includes/lib/class.yith-commissions-list-table-premium.php';
//                file_exists( $file ) && require_once ( $file );
//            }
        ...
        public function get_order_uri( $order_uri, $order_id ){
            return $order_uri = is_admin() ? $order_uri :  YITH_Frontend_Manager_Section_Orders::get_edit_order_permalink( $order_id );
        }
        ...
        public function get_product_uri( $product_uri, $product_id ){
            return $product_uri = is_admin() ? $product_uri : YITH_Frontend_Manager_Section_Products::get_edit_product_link( $product_id );
        }
    }

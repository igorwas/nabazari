...
if( ! class_exists( 'YITH_Frontend_Manager_Section_Products' ) ) {
    ...
    class YITH_Frontend_Manager_Section_Products extends YITH_WCFM_Section {
        ...
        public static function save_product( $array ) {
            ...
            $array['comment_status'] = isset( $array['_reviews_allowed'] ) ? $array['_reviews_allowed'] : 0;
            ...
            if ( ! is_wp_error( $post_id ) && $post_id > 0 ) {
                ...
                update_post_meta( $post_id, '_sku'                      , $array['_sku'] );
                ...
                if( ! empty( $array['product_gallery'] ) ){
                    update_post_meta( $post_id, '_product_image_gallery' , implode( ',', $array['product_gallery'] ) );
                }
        ...
        public static function delete( $product_id ){
            $product = wc_get_product( $product_id );
            $check = $product instanceof  WC_Product ? $product->delete( true ) : false;

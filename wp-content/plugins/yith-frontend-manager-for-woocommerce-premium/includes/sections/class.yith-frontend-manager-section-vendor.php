...
if( ! class_exists( 'YITH_Frontend_Manager_Section_Vendor' ) && function_exists( 'YITH_Vendors' ) ) {
	...
	class YITH_Frontend_Manager_Section_Vendor extends YITH_WCFM_Section {
        ...
        public function prevent_admin_access( $prevent_access ) {
            ...
            if( ! $is_upload_image && ! $is_save_vendor_panel && ! $is_media_library && current_user_can( YITH_Vendors()->get_role_name() ) && 'yes' == get_option( 'yith_wcfm_prevent_backend_access_for_vendor', 'no' ) ){
                $prevent_access = true;
            }

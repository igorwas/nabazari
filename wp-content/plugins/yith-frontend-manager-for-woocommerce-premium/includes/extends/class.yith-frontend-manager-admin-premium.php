    ...
    class YITH_Frontend_Manager_Admin_Premium extends YITH_Frontend_Manager_Admin {
        ...
        public function register_plugin_for_activation() {
            if ( ! class_exists( 'YIT_Plugin_Licence' ) ) {
                require_once YITH_WCFM_PATH . 'plugin-fw/licence/lib/yit-licence.php';
                require_once YITH_WCFM_PATH . 'plugin-fw/licence/lib/yit-plugin-licence.php';
            }
        ...
        public function prevent_admin_access( $prevent_access ) {
            ...
            if( ! $is_media_library && ! $is_upload_image && 'yes' == get_option( 'yith_wcfm_prevent_backend_access', 'no' ) ){

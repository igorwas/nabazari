...
if( ! class_exists( 'YITH_Frontend_Manager_Admin' ) ){
    ...
    class YITH_Frontend_Manager_Admin {
        ...
        public function __construct(){
            ...
            /* Flush rewrite rule after theme switching or if user click on flush rewrite rules button */
            add_action( 'switch_theme', 'YITH_Frontend_Manager::regenerate_transient_rewrite_rule_transient' );

...
if ( isset( $_POST['act'] ) && isset( $_POST['post_title'] ) && $_POST['post_title'] != '' ) {
...
$coupon_code = isset( $_POST['post_title'] ) ? $_POST['post_title'] : ( isset( $_GET['code'] ) ? $_GET['code'] : '' );
$coupon = new WC_Coupon( $coupon_code );
...
<div id="yith-wcfm-coupon" class="add-coupon">
    ...
    <form name="post" action="?page_id=<?php echo $page_id; ?>&coupons=coupon" method="post" id="post">
        ...
        <div class="options_group">
            ...
            <p class="form-field expiry_date_field ">
                ...
                <input type="text" class="date-picker hasDatepicker" style="" name="expiry_date" id="expiry_date" value="<?php echo $expiry_date; ?>" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])">
            </p>
        ...
        <div class="options_group">
            ...
            <p class="form-field">
                ...
                <select name="product_categories[]" class="product_categories-select2" multiple="multiple" placeholder="Applied to..."><?php
                    echo_product_categories_childs_of( 0, 0, $product_categories );
                ?></select>
            </p>
            ...
            <p class="form-field">
                ...
                <select name="exclude_product_categories[]" class="exclude_product_categories-select2" multiple="multiple" placeholder="Applied to..."><?php
                    echo_product_categories_childs_of( 0, 0, $exclude_product_categories );
                ?></select>
            </p>
        </div>
    ...
    <script type="text/javascript">
        jQuery(".product_ids-select2").select2();
        jQuery(".exclude_product_ids-select2").select2();
        jQuery(".product_categories-select2").select2();
        jQuery(".exclude_product_categories-select2").select2();
    </script>

			...
			<table style="<?php echo $content_css; ?>" align="center" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td bgcolor="#ffffff" style="<?php echo $mailbody_css; ?>">
						<?php echo wpautop( $args['mail_body'] ); ?>
						<br />
						<b>
							<?php _e( 'Name', 'yith-live-chat' ) ?>:
						</b>
						<?php echo $args['name']; ?>
						<br />
						<b>
							<?php _e( 'E-mail', 'yith-live-chat' ) ?>:
						</b>
						<a href="mailto:<?php echo $args['email']; ?>">
							<?php echo $args['email']; ?>
						</a>
						<br />
						<b>
							<?php _e( 'Message', 'yith-live-chat' ) ?>:
						</b>
						<br />
						<?php echo str_replace( "\n", '<br />', htmlspecialchars( stripslashes( $args['message'] ) ) ); ?>
						<br />
						<br />
                        <span style="<?php echo $user_info_css ?>">
                            <?php _e( 'User information', 'yith-live-chat' ) ?>: <?php echo $args['ip_address'] . ' - ' . $args['os'] . ', ' . $args['browser'] . ' ' . $args['version'] ?>
	                        <br />
	                        <?php echo $args['page'] ?>
                        </span>
					</td>

			...
			<table style="<?php echo $content_css; ?>" align="center" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td bgcolor="#009edb" style="<?php echo $header_css; ?>">
						[<?php echo get_option( 'blogname' ) ?>] <?php echo $args['subject']; ?>
					</td>
				</tr>
				<tr>
					<td bgcolor="#ffffff" style="<?php echo $mailbody_css; ?>">
						<?php echo $args['mail_body']; ?>
						<br />
						<br />
						<?php if ( $args['chat_data'] != array() ) : ?>
							<b>
								<?php _e( 'User Name', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['user_name']; ?>
							<br />
							<b>
								<?php _e( 'User e-mail', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['user_email']; ?>
							<br />
							<b>
								<?php _e( 'IP Address', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['user_ip']; ?>
							<br />
							<br />
							<b>
								<?php _e( 'Operator Name', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['operator']; ?>
							<br />
							<b>
								<?php _e( 'Chat Duration', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['duration']; ?>
							<br />
							<b>
								<?php _e( 'Chat closed by', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['closed_by']; ?>
							<br />
							<b>
								<?php _e( 'Chat Evaluation', 'yith-live-chat' ) ?>:
							</b>
							<?php echo $args['chat_data']['evaluation']; ?>
							<br />
							<br />
						<?php endif; ?>
						<?php $chat_logs = ylc_get_chat_conversation( $args['cnv_id'] ); ?>

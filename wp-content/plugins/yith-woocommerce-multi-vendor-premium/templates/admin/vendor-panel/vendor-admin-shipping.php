...
<div class="wrap yith-vendor-admin-wrap" id="vendor-details">
    <form method="post" action="<?php echo apply_filters( 'yith_wcmv_vendor_panel_form_action', admin_url( 'admin.php' ) ); ?>" enctype="multipart/form-data" class="yith_admin_vendor_shipping">
        ...
        <div class="form-field">
            ...
            <span class="description"><?php _e( 'The additional price for the first product of every second product type in the cart.', 'yith-woocommerce-product-vendors' ); ?></span>
        </div>
        ...
        <div class="form-field">
            ...
            <span class="description"><?php _e( 'The additional price for every second product of the same type', 'yith-woocommerce-product-vendors' ); ?></span>
        </div>
        ...
        <div class="submit">
            <input name="Submit" type="submit" class="button-primary" value="<?php echo esc_attr( __( 'Save Shipping Settings', 'yith-woocommerce-product-vendors' ) ) ?>" />

...
<table class="wc-shipping-zones widefat">
    ...
    if( is_array( $vendor->zone_data ) ) {
        ...
        //YITH_Vendor_Shipping()->admin->print_line_option( 0, new WC_Shipping_Zone( 0 ) );
    ...
    <div class="wc-backbone-modal wc-backbone-modal-edit-shipping-mode">
        <div class="wc-backbone-modal-content">
            <section class="wc-backbone-modal-main" role="main">
                ...
                <footer>
                    <div class="inner">
                        <button id="btn-ok" class="button button-primary button-large"><?php _e( 'Save Changes', 'yith-woocommerce-product-vendors' ); ?></button>
                    </div>
                </footer>
            </section>
        </div>

...
<div id="yith-become-a-vendor" class="woocommerce shortcodes">
    ...
    <form method="post" class="register">
        ...
        <p class="form-row form-row-wide">
            ...
            <input type="text" class="input-text yith-required" name="vendor-location" id="vendor-location" value="<?php echo $store_location ?>" placeholder="<?php _e( "Store address. e.g.: MyStore S.A. Avenue MyStore 55, 1800 Vevey, Switzerland", 'yith-woocommerce-product-vendors' ); ?>">
        </p>
